...
export function RevertConfirmDialog({ onConfirm }: RevertConfirmDialogProps) {
    const { colors } = useTheme()
    const dialog = useDialog()

    const options = [
        { name: "Cancel", action: "cancel" as const, description: "Abort reversion" },
        { name: "Force Revert", action: "force" as const, description: "Discard uncommitted changes and revert" },
    ]
    ...
    return (
        ...
        >
            ...
            <text fg="white" attributes={TextAttributes.DIM}>
                Reverting will permanently overwrite all uncommitted modifications on disk.
            </text>
